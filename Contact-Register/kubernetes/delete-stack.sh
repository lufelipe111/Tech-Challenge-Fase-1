...
# Note: This script does NOT delete PersistentVolumeClaims (PVCs) to prevent data loss.
# If you want to delete the data and start fresh, you must manually delete the PVCs:
# kubectl delete pvc mssql-pvc rabbitmq-pvc prometheus-pvc grafana-pvc
